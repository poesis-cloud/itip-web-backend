...
@Entity
@Table(name = "capability_change_audit")
@Getter
@Immutable
...
@AllArgsConstructor
public class CapabilityChangeAudit {
  ...
  @JoinColumn(
      ...
      nullable = false,
      updatable = false,
      foreignKey = @ForeignKey(name = "fk_capability_change_audit_capability"))
  private Capability capability;

  @Column(name = "capability_version", nullable = false, updatable = false)
  private long capabilityVersion;

  @Enumerated(EnumType.STRING)
  @Column(name = "action_type", nullable = false, updatable = false)
  private CapabilityAuditActionType actionType;
